...
// Lecture 49 - Adding video recording
...
var drawingCanvas, drawingCanvasCtx, drawingCanvasLostFocus, currentSetOfPoints,
    currentEllipse, currentCurve, currentBezierCurve, currentText, tmpCenter,
    mediaRecorder;
...
function GetButtonImage(k) {
    if (buttons[k].State === 'Selected' || (buttons[k].ActionType ===
...
function Setup() {
    ...
    AddButton(845, 5, 50, 50, './Images/FlipVertical.png', '',
        './Images/FlipVerticalMouseOver.png', 'UnSelected', 'FlipVertical',
        function () {
            if (selectedSetOfPointsIndex > -1) {
                var tmpCG = CalculateCenterOfGravityXY(
                    allSetsOfPoints[selectedSetOfPointsIndex]);
                for (var i = 0; i < allSetsOfPoints[
                    selectedSetOfPointsIndex].length; i++) {
                    var tmpY = allSetsOfPoints[selectedSetOfPointsIndex][i].y;
                    if (tmpY < tmpCG.Y) {
                        allSetsOfPoints[selectedSetOfPointsIndex][i].y = tmpY +
                            2 * Math.abs(tmpY - tmpCG.Y);
                ...
                var tmpCenterY = (allCurves[selectedCurve].StartY +
                    allCurves[selectedCurve].EndY) / 2;
                if (allCurves[selectedCurve].StartY < tmpCenterY) {
                    allCurves[selectedCurve].StartY =
                        allCurves[selectedCurve].StartY + 2 *
                        Math.abs(allCurves[selectedCurve].StartY - tmpCenterY);
                ...
                if (allCurves[selectedCurve].ControlPointY < tmpCenterY) {
                    allCurves[selectedCurve].ControlPointY =
                        allCurves[selectedCurve].ControlPointY + 2 *
                        Math.abs(allCurves[selectedCurve].ControlPointY - tmpCenterY);
                ...
                if (allCurves[selectedCurve].EndY < tmpCenterY) {
                    allCurves[selectedCurve].EndY =
                        allCurves[selectedCurve].EndY + 2 *
                        Math.abs(allCurves[selectedCurve].EndY - tmpCenterY);
                ...
                if (allBezierCurves[selectedBezierCurve].StartY < tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].StartY =
                        allBezierCurves[selectedBezierCurve].StartY +
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].StartY -
                            tmpCenterY2);
                } else if (allBezierCurves[selectedBezierCurve].StartY >
                    tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].StartY =
                        allBezierCurves[selectedBezierCurve].StartY -
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].StartY -
                ...
                if (allBezierCurves[selectedBezierCurve].ControlPoint1Y <
                    tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint1Y =
                        allBezierCurves[selectedBezierCurve].ControlPoint1Y +
                        2 * Math.abs(allBezierCurves[
                            selectedBezierCurve].ControlPoint1Y - tmpCenterY2);
                } else if (allBezierCurves[selectedBezierCurve].ControlPoint1Y >
                    tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint1Y =
                        allBezierCurves[selectedBezierCurve].ControlPoint1Y -
                        2 * Math.abs(allBezierCurves[
                ...
                if (allBezierCurves[selectedBezierCurve].ControlPoint2Y <
                    tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint2Y =
                        allBezierCurves[selectedBezierCurve].ControlPoint2Y +
                        2 * Math.abs(allBezierCurves[
                            selectedBezierCurve].ControlPoint2Y - tmpCenterY2);
                } else if (allBezierCurves[selectedBezierCurve].ControlPoint2Y >
                    tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint2Y =
                        allBezierCurves[selectedBezierCurve].ControlPoint2Y -
                        2 * Math.abs(allBezierCurves[
                ...
                if (allBezierCurves[selectedBezierCurve].EndY < tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].EndY =
                        allBezierCurves[selectedBezierCurve].EndY +
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].EndY -
                            tmpCenterY2);
                } else if (allBezierCurves[selectedBezierCurve].EndY >
                    tmpCenterY2) {
                    allBezierCurves[selectedBezierCurve].EndY =
                        allBezierCurves[selectedBezierCurve].EndY -
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].EndY -
    ...
    AddButton(905, 5, 50, 50, './Images/FlipHorizontal.png', '',
        './Images/FlipHorizontalMouseOver.png', 'UnSelected', 'FlipHorizontal',
        function () {
            if (selectedSetOfPointsIndex > -1) {
                var tmpCG = CalculateCenterOfGravityXY(allSetsOfPoints[
                    selectedSetOfPointsIndex]);
                for (var i = 0; i < allSetsOfPoints[
                    selectedSetOfPointsIndex].length; i++) {
                    var tmpX = allSetsOfPoints[selectedSetOfPointsIndex][i].x;
                    if (tmpX < tmpCG.X) {
                        allSetsOfPoints[selectedSetOfPointsIndex][i].x =
                            tmpX + 2 * Math.abs(tmpX - tmpCG.X);
                ...
                var tmpCenterX = (allCurves[selectedCurve].StartX +
                    allCurves[selectedCurve].EndX) / 2;
                if (allCurves[selectedCurve].StartX < tmpCenterX) {
                    allCurves[selectedCurve].StartX =
                        allCurves[selectedCurve].StartX + 2 *
                        Math.abs(allCurves[selectedCurve].StartX - tmpCenterX);
                ...
                if (allCurves[selectedCurve].ControlPointX < tmpCenterX) {
                    allCurves[selectedCurve].ControlPointX =
                        allCurves[selectedCurve].ControlPointX +
                        2 * Math.abs(allCurves[selectedCurve].ControlPointX -
                            tmpCenterX);
                ...
                if (allCurves[selectedCurve].EndX < tmpCenterX) {
                    allCurves[selectedCurve].EndX = allCurves[selectedCurve].EndX +
                        2 * Math.abs(allCurves[selectedCurve].EndX - tmpCenterX);
                ...
                if (allBezierCurves[selectedBezierCurve].StartX < tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].StartX =
                        allBezierCurves[selectedBezierCurve].StartX +
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].StartX -
                            tmpCenterX2);
                } else if (allBezierCurves[selectedBezierCurve].StartX >
                    tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].StartX =
                        allBezierCurves[selectedBezierCurve].StartX -
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].StartX -
                ...
                if (allBezierCurves[selectedBezierCurve].ControlPoint1X <
                    tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint1X =
                        allBezierCurves[selectedBezierCurve].ControlPoint1X +
                        2 * Math.abs(allBezierCurves[
                            selectedBezierCurve].ControlPoint1X - tmpCenterX2);
                } else if (allBezierCurves[selectedBezierCurve].ControlPoint1X >
                    tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint1X =
                        allBezierCurves[selectedBezierCurve].ControlPoint1X -
                        2 * Math.abs(allBezierCurves[
                ...
                if (allBezierCurves[selectedBezierCurve].ControlPoint2X <
                    tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint2X =
                        allBezierCurves[selectedBezierCurve].ControlPoint2X +
                        2 * Math.abs(allBezierCurves[
                            selectedBezierCurve].ControlPoint2X - tmpCenterX2);
                } else if (allBezierCurves[selectedBezierCurve].ControlPoint2X >
                    tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].ControlPoint2X =
                        allBezierCurves[selectedBezierCurve].ControlPoint2X -
                        2 * Math.abs(allBezierCurves[
                ...
                if (allBezierCurves[selectedBezierCurve].EndX < tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].EndX =
                        allBezierCurves[selectedBezierCurve].EndX +
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].EndX -
                            tmpCenterX2);
                } else if (allBezierCurves[selectedBezierCurve].EndX >
                    tmpCenterX2) {
                    allBezierCurves[selectedBezierCurve].EndX =
                        allBezierCurves[selectedBezierCurve].EndX -
                        2 * Math.abs(allBezierCurves[selectedBezierCurve].EndX -
    ...
    AddButton(965, 5, 50, 50, './Images/Scale.png', './Images/ScalePressed.png',
        './Images/ScaleMouseOver.png', 'UnSelected', 'Scale');

    AddButton(1025, 5, 50, 50, './Images/Rotation.png',
        './Images/RotationPressed.png', './Images/RotationMouseOver.png',
        'UnSelected', 'Rotation');

    AddButton(1085, 5, 50, 50, './Images/SaveImage.png', '',
        './Images/SaveImageMouseOver.png', 'UnSelected', 'SaveImage',
        function () {
    ...
    AddButton(1145, 5, 50, 50, './Images/CopyJStoClipboard.png', '',
        './Images/CopyJStoClipboardMouseOver.png', 'UnSelected', 'CopyJStoClipboard',
        function () {
            var codeString = 'var myDrawingPoints = new Array(), ' +
                'myDrawingPointsColors = new Array(), myDrawingEllipses = ' +
                'new Array(), myDrawingEllipsesColors = new Array(), ' +
                'myDrawingTexts = new Array(), myDrawingTextsColors = ' +
                'new Array(), myDrawingCurves = new Array(), ' +
                'myDrawingCurvesColors = new Array(), myDrawingBezierCurves' +
            ...
            if (allSetsOfPoints.length > 0) {
                ...
                for (var i = 0; i < allSetsOfPoints.length - 1; i++) {
                    ...
                    for (var j = 0; j < allSetsOfPoints[i].length - 1; j++) {
                        codeString += '{ x: ' + allSetsOfPoints[i][j].x +
                            ', y: ' + allSetsOfPoints[i][j].y + ' }, ';
                    }
                    codeString += '{ x: ' + allSetsOfPoints[i][j].x +
                        ', y: ' + allSetsOfPoints[i][j].y + ' }], ';
                }
                codeString += '[';
                for (var f = 0; f < allSetsOfPoints[
                    allSetsOfPoints.length - 1].length - 1; f++) {
                    codeString += '{ x: ' + allSetsOfPoints[
                        allSetsOfPoints.length - 1][f].x + ', y: ' +
                        allSetsOfPoints[allSetsOfPoints.length - 1][f].y +
                        ' }, ';
                }
                codeString += '{ x: ' + allSetsOfPoints[
                    allSetsOfPoints.length - 1][allSetsOfPoints[
                        allSetsOfPoints.length - 1].length - 1].x + ', y: ' +
                    allSetsOfPoints[allSetsOfPoints.length - 1][
                        allSetsOfPoints[allSetsOfPoints.length - 1].length -
                        1].y + ' }]];\n';
                if (selectedSetOfPointsColor.length > 0) {
                    codeString += 'myDrawingPointsColors = [';
                    for (var u = 0; u < selectedSetOfPointsColor.length - 1; u++) {
                        codeString += '{ Idx: ' + selectedSetOfPointsColor[u].Idx
                            + ', Color: \'' + selectedSetOfPointsColor[u].Color
                            + '\' }, ';
                    }
                    codeString += '{ Idx: ' + selectedSetOfPointsColor[
                        selectedSetOfPointsColor.length - 1].Idx +
                        ', Color: \'' + selectedSetOfPointsColor[
                            selectedSetOfPointsColor.length - 1].Color + '\' }];\n';
                }
            }
            if (allEllipses.length > 0) {
                codeString += 'myDrawingEllipses = [';
                for (var d = 0; d < allEllipses.length - 1; d++) {
                    codeString += '{ CenterX: ' + allEllipses[d].CenterX +
                        ', CenterY: ' + allEllipses[d].CenterY +
                        ', SemiMajorAxisLength: ' + allEllipses[
                            d].SemiMajorAxisLength + ', SemiMinorAxisLength: ' +
                        allEllipses[d].SemiMinorAxisLength + ',  Angle: ' +
                        allEllipses[d].Angle + ', StartAngle: 0, EndAngle: ' +
                        '2 * Math.PI}, ';
                }
                codeString += '{ CenterX: ' + allEllipses[
                    allEllipses.length - 1].CenterX + ', CenterY: ' +
                    allEllipses[allEllipses.length - 1].CenterY +
                    ', SemiMajorAxisLength: ' + allEllipses[
                        allEllipses.length - 1].SemiMajorAxisLength +
                    ', SeminMinorAxisLength: ' + allEllipses[
                        allEllipses.length - 1].SemiMinorAxisLength + ', Angle: ' +
                    allEllipses[allEllipses.length - 1].Angle +
                    ', StartAngle: 0, EndAngle: 2 * Math.PI }]; \n';
                if (selectedEllipseColor.length > 0) {
                    codeString += 'myDrawingEllipsesColors = [';
                    for (var a = 0; a < selectedEllipseColor.length - 1; a++) {
                        codeString += '{ Idx: ' + selectedEllipseColor[a].Idx +
                            ', Color: \'' + selectedEllipseColor[a].Color +
                            '\' }, ';
                    }
                    codeString += '{ Idx: ' + selectedEllipseColor[
                        selectedEllipseColor.length - 1].Idx +
                        ', Color: \'' + selectedEllipseColor[
                            selectedEllipseColor.length - 1].Color +
                        '\' }];\n';
                }
            }
            if (allText.length > 0) {
                ...
                for (var k = 0; k < allText.length - 1; k++) {
                    codeString += '{ X: ' + allText[k].X + ', Y: ' +
                        allText[k].Y + ', Value: \'' + allText[k].Value +
                        '\', FontSize: ' + allText[k].FontSize +
                        ', FontName: \'' + allText[k].FontName +
                        '\', Width: ' + allText[k].Width + ', Angle: ' +
                        (allText[k].Angle ? allText[k].Angle : 0) +
                        ', FlipHorizontal: ' + (allText[k].FlipHorizontal ?
                            allText[k].FlipHorizontal : false) +
                        ', FlipVertical: ' + (allText[k].FlipVertical ?
                            allText[k].FlipVertical : false) + ' }, ';
                }
                codeString += '{ X: ' + allText[allText.length - 1].X +
                    ', Y: ' + allText[allText.length - 1].Y +
                    ', Value: \'' + allText[allText.length - 1].Value +
                    '\', FontSize: ' + allText[allText.length - 1].FontSize +
                    ', FontName: \'' + allText[allText.length - 1].FontName
                    + '\', Width: ' + allText[allText.length - 1].Width +
                    ', Angle: ' + (allText[allText.length - 1].Angle ?
                        allText[allText.length - 1].Angle : 0) +
                    ', FlipHorizontal: ' +
                    (allText[allText.length - 1].FlipHorizontal ?
                        allText[allText.length - 1].FlipHorizontal : false) +
                    ', FlipVertical: ' +
                    (allText[allText.length - 1].FlipVertical ?
                        allText[allText.length - 1].FlipVertical : false) +
                    ' }];\n';
                if (selectedTextColor.length > 0) {
                    codeString += 'myDrawingTextsColors = [';
                    for (var h = 0; h < selectedTextColor.length - 1; h++) {
                        codeString += '{ Idx: ' + selectedTextColor[h].Idx +
                            ', Color: \'' + selectedTextColor[h].Color + '\' }, ';
                    }
                    codeString += '{ Idx: ' + selectedTextColor[
                        selectedTextColor.length - 1].Idx +
                        ', Color: \'' + selectedTextColor[
                            selectedTextColor.length - 1].Color + '\' }];\n';
                }
            }
            if (allCurves.length > 0) {
                codeString += 'myDrawingCurves = [';
                for (var g = 0; g < allCurves.length - 1; g++) {
                    codeString += '{ StartX: ' + allCurves[g].StartX +
                        ', StartY: ' + allCurves[g].StartY + ', ControlPointX: ' +
                        allCurves[g].ControlPointX + ', ControlPointY: ' +
                        allCurves[g].ControlPointY + ', EndX: ' +
                        allCurves[g].EndX + ', EndY: ' + allCurves[g].EndY + ' }, ';
                }
                codeString += '{ StartX: ' + allCurves[allCurves.length -
                    1].StartX + ', StartY: ' +
                    allCurves[allCurves.length - 1].StartY + ', ControlPointX: ' +
                    allCurves[allCurves.length - 1].ControlPointX +
                    ', ControlPointY: ' + allCurves[allCurves.length -
                        1].ControlPointY + ', EndX: ' +
                    allCurves[allCurves.length - 1].EndX + ', EndY: ' +
                    allCurves[allCurves.length - 1].EndY + ' }];\n';
                if (selectedCurveColor.length > 0) {
                    codeString += 'myDrawingCurvesColors = [';
                    for (var v = 0; v < selectedCurveColor.length - 1; v++) {
                        codeString += '{ Idx: ' + selectedCurveColor[v].Idx +
                            ', Color: \'' + selectedCurveColor[v].Color +
                            '\' }, ';
                    }
                    codeString += '{ Idx: ' + selectedCurveColor[
                        selectedCurveColor.length - 1].Idx +
                        ', Color: \'' + selectedCurveColor[
                            selectedCurveColor.length - 1].Color + '\' }];\n';
                }
            }
            if (allBezierCurves.length > 0) {
                codeString += 'myDrawingBezierCurves = [';
                for (var g = 0; g < allBezierCurves.length - 1; g++) {
                    codeString += '{ StartX: ' + allBezierCurves[g].StartX +
                        ', StartY: ' +
                        ...
                        allBezierCurves[g].EndX + ', EndY: ' +
                        allBezierCurves[g].EndY + ' }, ';
                }
                codeString += '{ StartX: ' + allBezierCurves[
                    allBezierCurves.length - 1].StartX + ', StartY: ' +
                    allBezierCurves[allBezierCurves.length - 1].StartY +
                    ', ControlPoint1X: ' +
                    allBezierCurves[allBezierCurves.length -
                        1].ControlPoint1X + ', ControlPoint1Y: ' +
                    allBezierCurves[allBezierCurves.length -
                        1].ControlPoint1Y + ', ControlPoint2X: ' +
                    allBezierCurves[allBezierCurves.length -
                        1].ControlPoint2X + ', ControlPoint2Y: ' +
                    allBezierCurves[allBezierCurves.length -
                        1].ControlPoint2Y + ', EndX: ' +
                    allBezierCurves[allBezierCurves.length -
                        1].EndX + ', EndY: ' +
                    allBezierCurves[allBezierCurves.length -
                        1].EndY + ' }];\n';
                if (selectedBezierCurveColor.length > 0) {
                    ...
                    for (var v = 0; v < selectedBezierCurveColor.length - 1;
                        v++) {
            ...
            codeString += 'c = document.getElementById(\'YourCanvasIDName\');' +
                ...
                '\t\tctx.beginPath();\n\t\tctx.moveTo(myDrawingPoints[i]' +
                '[0].x, myDrawingPoints[i][0].y); \n\t\t' +
                'for (var j = 1; j < myDrawingPoints[i].length; j++) {' +
                '\n\t\t\tctx.lineTo(myDrawingPoints[i][j].x, ' +
                'myDrawingPoints[i][j].y); \n' +
                '\t\t}\n\t\tvar setColor = false;\n\t\tfor (var r = 0; ' +
                'r < myDrawingPointsColors.length; r++) {\n' +
            ...
            codeString += 'for (var t = 0; t < myDrawingEllipses.length; t++)' +
                ...
                'myDrawingEllipses[t].Angle, myDrawingEllipses[t].StartAngle, ' +
                'myDrawingEllipses[t].EndAngle, 0); \n\t' +
                'var setColor2 = false;\n\tfor (var q = 0; q < ' +
                'myDrawingEllipsesColors.length; q++) {\n\t\t' +
            ...
            codeString += 'for (var d = 0; d < myDrawingTexts.length; d++)' +
                ...
                'ctx.font = myDrawingTexts[d].FontSize + \'px \' + ' +
                'myDrawingTexts[d].FontName; \n\tctx.save(); \n\t' +
                'ctx.translate(myDrawingTexts[d].X + myDrawingTexts[d].Width ' +
                '/ 2, myDrawingTexts[d].Y + myDrawingTexts[d].FontSize / ' +
                '2); \n\t' +
                'if (myDrawingTexts[d].Angle !== 0) {\n\t\tif (' +
                'myDrawingTexts[d].Angle < 0) {\n\t\t\tctx.rotate(2 * ' +
                'Math.PI + myDrawingTexts[d].Angle); \n\t\t' +
                '} else {\n\t\t\tctx.rotate(myDrawingTexts[d].Angle);\n\t\t' +
                '}\n\t}\n\tif(myDrawingTexts[d].FlipHorizontal) {\n\t\t' +
                'ctx.scale(-1, 1); \n\t' +
                '}\n\tif (myDrawingTexts[d].FlipVertical) {\n\t\tctx.scale(' +
                '1, -1); \n\t} \n\t' +
                'ctx.fillText(myDrawingTexts[d].Value, -myDrawingTexts[d]' +
                '.Width / 2, -myDrawingTexts[d].FontSize / 2); \n\t' +
                'ctx.restore(); \n} \n';
            codeString += 'for (var a = 0; a < myDrawingCurves.length; a++) ' +
                '{\n\tctx.beginPath();\n\tctx.moveTo(myDrawingCurves[a].StartX, ' +
                'myDrawingCurves[a].StartY); \n\tctx.quadraticCurveTo(' +
                'myDrawingCurves[a].ControlPointX, ' +
                'myDrawingCurves[a].ControlPointY, myDrawingCurves[a].EndX, ' +
                'myDrawingCurves[a].EndY); \n\tvar setColor4 = false; \n\t' +
                ...
                'if(!setColor4) {\n\t\t' +
                'ctx.strokeStyle = \'#000000\';\n\t}\n\tctx.stroke();\n}\n';
            codeString += 'for (var a = 0; a < myDrawingBezierCurves.length; ' +
                'a++) {\n\tctx.beginPath(); \n\tctx.moveTo(' +
                'myDrawingBezierCurves[a].StartX, ' +
                'myDrawingBezierCurves[a].StartY); \n\tctx.' +
                'bezierCurveTo(myDrawingBezierCurves[a].ControlPoint1X, ' +
                'myDrawingBezierCurves[a].ControlPoint1Y, ' +
                'myDrawingBezierCurves[a].ControlPoint2X, ' +
                'myDrawingBezierCurves[a].ControlPoint2Y, ' +
                'myDrawingBezierCurves[a].EndX, myDrawingBezierCurves[a].EndY);' +
                '\n\tvar setColor4 = false; \n\t' +
                'for (var g = 0; g < myDrawingBezierCurvesColors.length; ' +
    ...
    AddButton(1205, 5, 50, 50, './Images/Recorder.png',
        './Images/RecorderPressed.png', './Images/RecorderMouseOver.png',
        'UnSelected', 'Recorder',
        function () {
            if (!isRecording) {
                isRecording = true;
                ...
                mediaRecorder.ondataavailable = function (e) {
                    var a = document.createElement('a');
                    a.download = ['video_', (new Date() + '').slice(4, 28),
                        '.webm'].join('');
...
function drawingCanvasOnMouseDown(e) {
    if (e.button === 0) {
        ...
        if (actionType === 'Pencil' || actionType === 'Line' ||
            ...
            tmpCenter = CalculateCenterOfGravityXY(allSetsOfPoints[
                selectedSetOfPointsIndex]);
            tmpRotatedPoints = new Array();
            for (var i = 0; i < allSetsOfPoints[
                selectedSetOfPointsIndex].length; i++) {
                tmpRotatedPoints.push({
                    x: allSetsOfPoints[
                        selectedSetOfPointsIndex][i].x - tmpCenter.X,
                    y: allSetsOfPoints[selectedSetOfPointsIndex][i].y -
                    tmpCenter.Y
                });
            }
    ...
    if (leftMouseButtonDown && !drawingCanvasLostFocus && actionType === 'Rotation') {
        if (selectedSetOfPointsIndex > -1) {
            ...
            for (var j = 0; j < tmpRotatedPoints.length; j++) {
                allSetsOfPoints[selectedSetOfPointsIndex][j].x =
                    Math.round(tmpRotatedPoints[j].x * costheta -
                        tmpRotatedPoints[j].y * sintheta + tmpCenter.X);
                allSetsOfPoints[selectedSetOfPointsIndex][j].y =
                    Math.round(tmpRotatedPoints[j].y * costheta +
                        tmpRotatedPoints[j].x * sintheta + tmpCenter.Y);
            }
            Draw();
        } else if (selectedEllipse > -1) {
            var centerX = (allEllipses[selectedEllipse].TopLeftX +
                allEllipses[selectedEllipse].BottomRightX) / 2;
            var centerY = (allEllipses[selectedEllipse].TopLeftY +
                allEllipses[selectedEllipse].BottomRightY) / 2;
            var tmpX2 = pos_left - centerX;
            var tmpY2 = pos_top - centerY;
            allEllipses[selectedEllipse].Angle = Math.asin(tmpY2 /
            ...
            allCurves[selectedCurve].Angle = Math.asin(tmpY2 /
                Math.sqrt(tmpX2 * tmpX2 + tmpY2 * tmpY2));
            ...
            var controlPointX = allCurves[selectedCurve].ControlPointX -
                tmpCenterX;
            var controlPointY = allCurves[selectedCurve].ControlPointY -
                tmpCenterY;
            var endX = allCurves[selectedCurve].EndX - tmpCenterX;
            var endY = allCurves[selectedCurve].EndY - tmpCenterY;
            if (!(startX === 0 && startY === 0)) {
                allCurves[selectedCurve].StartX = Math.round(startX *
                    costheta2 - startY * sintheta2 + tmpCenterX);
                allCurves[selectedCurve].StartY = Math.round(startY *
                    costheta2 + startX * sintheta2 + tmpCenterY);
            } else {
            ...
            if (!(controlPointX === 0 && controlPointY === 0)) {
                allCurves[selectedCurve].ControlPointX =
                    Math.round(controlPointX * costheta2 -
                        controlPointY * sintheta2 + tmpCenterX);
                allCurves[selectedCurve].ControlPointY =
                    Math.round(controlPointY * costheta2 +
                        controlPointX * sintheta2 + tmpCenterY);
            } else {
                allCurves[selectedCurve].ControlPointX += tmpCenterX;
                allCurves[selectedCurve].ControlPointY += tmpCenterY;
            }
            if (!(endX === 0 && endY === 0)) {
                allCurves[selectedCurve].EndX = Math.round(endX *
                    costheta2 - endY * sintheta2 + tmpCenterX);
                allCurves[selectedCurve].EndY = Math.round(endY *
                    costheta2 + endX * sintheta2 + tmpCenterY);
            } else {
            ...
            var controlPoint1X = allBezierCurves[selectedBezierCurve].ControlPoint1X
                - tmpCenterX;
            var controlPoint1Y = allBezierCurves[selectedBezierCurve].ControlPoint1Y
                - tmpCenterY;
            var controlPoint2X = allBezierCurves[selectedBezierCurve].ControlPoint2X
                - tmpCenterX;
            var controlPoint2Y = allBezierCurves[selectedBezierCurve].ControlPoint2Y
                - tmpCenterY;
            var endX = allBezierCurves[selectedBezierCurve].EndX - tmpCenterX;
            var endY = allBezierCurves[selectedBezierCurve].EndY - tmpCenterY;
            if (!(startX === 0 && startY === 0)) {
                allBezierCurves[selectedBezierCurve].StartX =
                    Math.round(startX * costheta2 - startY * sintheta2 +
                        tmpCenterX);
                allBezierCurves[selectedBezierCurve].StartY =
                    Math.round(startY * costheta2 + startX * sintheta2 +
                        tmpCenterY);
            } else {
            ...
            if (!(controlPoint1X === 0 && controlPoint1Y === 0)) {
                allBezierCurves[selectedBezierCurve].ControlPoint1X =
                    Math.round(controlPoint1X * costheta2 - controlPoint1Y *
                        sintheta2 + tmpCenterX);
                allBezierCurves[selectedBezierCurve].ControlPoint1Y =
                    Math.round(controlPoint1Y * costheta2 + controlPoint1X *
                        sintheta2 + tmpCenterY);
            } else {
            ...
            if (!(controlPoint2X === 0 && controlPoint2Y === 0)) {
                allBezierCurves[selectedBezierCurve].ControlPoint2X =
                    Math.round(controlPoint2X * costheta2 - controlPoint2Y *
                        sintheta2 + tmpCenterX);
                allBezierCurves[selectedBezierCurve].ControlPoint2Y =
                    Math.round(controlPoint2Y * costheta2 + controlPoint2X *
                        sintheta2 + tmpCenterY);
            } else {
                allBezierCurves[selectedBezierCurve].ControlPoint2X +=
                    tmpCenterX;
            ...
            var tmpX2 = pos_left - (allText[selectedText].X +
                allText[selectedText].Width / 2);
            var tmpY2 = pos_top - (allText[selectedText].Y +
                allText[selectedText].FontSize / 2);
            allText[selectedText].Angle = Math.asin(tmpY2 /
                Math.sqrt(tmpX2 * tmpX2 + tmpY2 * tmpY2));
            Draw();
        }
    }
...
function SelectEllipse(x, y) {
    for (var i = 0; i < allEllipses.length; i++) {
        ...
        if (allEllipses[i].Angle === 0) {
            ...
            var g = 2 * tmpX * b * b * costheta * sintheta - 2 * tmpX *
                a * a * sintheta * costheta;
            var h = b * b * tmpX * tmpX * costheta * costheta + a * a *
                tmpX * tmpX * sintheta * sintheta
                - a * a * b * b;
            if (f === 0) {
                var yGivenX = -h / g;
...
function SelectText(pos_left, pos_top) {
    for (var h = 0; h < allText.length; h++) {
        if (allText[h].Angle === 0) {
            ...
            var minX1X2 = Math.min(allText[h].X - centerX, allText[h].X +
                allText[h].Width - centerX);
            var maxX1X2 = Math.max(allText[h].X - centerX, allText[h].X +
                allText[h].Width - centerX);
            var minY1Y2 = Math.min(allText[h].Y - centerY, allText[h].Y -
                allText[h].FontSize - centerY);
            var maxY1Y2 = Math.max(allText[h].Y - centerY, allText[h].Y -
                allText[h].FontSize - centerY);
            if (minX1X2 <= newTmpX && maxX1X2 >= newTmpX && minY1Y2 <=
                newTmpY && maxY1Y2 >= newTmpY) {
                if (selectedText === h) {
                    FreeAllReferences();
                } else {
                    FreeAllReferences();
    ...
    if (actionType === 'Scale') {
        if (selectedSetOfPointsIndex > -1) {
            if (originalPointsBeingScaled.length === 0) {
                for (var i = 0; i < allSetsOfPoints[
                    selectedSetOfPointsIndex].length; i++) {
                    originalPointsBeingScaled.push({
                        x: allSetsOfPoints[selectedSetOfPointsIndex][i].x,
                        y: allSetsOfPoints[selectedSetOfPointsIndex][i].y
                    });
                }
            ...
            for (var j = 0; j < originalPointsBeingScaled.length; j++) {
                allSetsOfPoints[selectedSetOfPointsIndex][j].x =
                    Math.round(originalPointsBeingScaled[j].x * scaleFactor);
                allSetsOfPoints[selectedSetOfPointsIndex][j].y =
                    Math.round(originalPointsBeingScaled[j].y * scaleFactor);
            }
            var newCenter = CalculateCenterOfGravityXY(
                allSetsOfPoints[selectedSetOfPointsIndex]);
            for (var x = 0; x < allSetsOfPoints[
                selectedSetOfPointsIndex].length; x++) {
                allSetsOfPoints[selectedSetOfPointsIndex][x].x -=
                    newCenter.X - tmpCenter.X;
                allSetsOfPoints[selectedSetOfPointsIndex][x].y -=
                    newCenter.Y - tmpCenter.Y;
            }
            Draw();
        } else if (selectedEllipse > -1) {
            var scaleFactorEllipse = e.deltaY < 0 ? 1.1 : 0.9;
            if ((allEllipses[selectedEllipse].SemiMajorAxisLength > 10 &&
                allEllipses[selectedEllipse].SemiMinorAxisLength > 10 &&
                scaleFactorEllipse === 0.9) || scaleFactorEllipse === 1.1) {
                var centerX = (allEllipses[selectedEllipse].TopLeftX +
                    allEllipses[selectedEllipse].BottomRightX) / 2;
                var centerY = (allEllipses[selectedEllipse].TopLeftY +
                    allEllipses[selectedEllipse].BottomRightY) / 2;
                allEllipses[selectedEllipse].TopLeftX =
                    Math.round(allEllipses[selectedEllipse].TopLeftX *
                        scaleFactorEllipse);
                allEllipses[selectedEllipse].TopLeftY =
                    Math.round(allEllipses[selectedEllipse].TopLeftY *
                        scaleFactorEllipse);
                allEllipses[selectedEllipse].BottomRightX =
                    Math.round(allEllipses[selectedEllipse].BottomRightX *
                        scaleFactorEllipse);
                allEllipses[selectedEllipse].BottomRightY =
                    Math.round(allEllipses[selectedEllipse].BottomRightY *
                        scaleFactorEllipse);
                allEllipses[selectedEllipse].SemiMajorAxisLength =
                    Math.abs(allEllipses[selectedEllipse].TopLeftX -
                        allEllipses[selectedEllipse].BottomRightX);
                allEllipses[selectedEllipse].SemiMinorAxisLength =
                    Math.abs(allEllipses[selectedEllipse].TopLeftY -
                        allEllipses[selectedEllipse].BottomRightY);
                var newCenterX = (allEllipses[selectedEllipse].TopLeftX +
                    allEllipses[selectedEllipse].BottomRightX) / 2;
                var newCenterY = (allEllipses[selectedEllipse].TopLeftY +
                    allEllipses[selectedEllipse].BottomRightY) / 2;
            ...
            var t1 = allCurves[selectedCurve].StartX -
                allCurves[selectedCurve].EndX;
            t1 *= t1;
            var t2 = allCurves[selectedCurve].StartY -
                allCurves[selectedCurve].EndY;
            t2 *= t2;
            if ((t1 + t2 > 10000 && scaleFactorCurve === 0.9) ||
                scaleFactorCurve === 1.1) {
                var centerX = (allCurves[selectedCurve].StartX +
                    allCurves[selectedCurve].EndX) / 2;
                var centerY = (allCurves[selectedCurve].StartY +
                    allCurves[selectedCurve].EndY) / 2;
                allCurves[selectedCurve].StartX =
                    Math.round(allCurves[selectedCurve].StartX *
                        scaleFactorCurve);
                allCurves[selectedCurve].StartY =
                    Math.round(allCurves[selectedCurve].StartY *
                        scaleFactorCurve);
                allCurves[selectedCurve].ControlPointX =
                    Math.round(allCurves[selectedCurve].ControlPointX *
                        scaleFactorCurve);
                allCurves[selectedCurve].ControlPointY =
                    Math.round(allCurves[selectedCurve].ControlPointY *
                        scaleFactorCurve);
                allCurves[selectedCurve].EndX =
                    Math.round(allCurves[selectedCurve].EndX *
                        scaleFactorCurve);
                allCurves[selectedCurve].EndY =
                    Math.round(allCurves[selectedCurve].EndY *
                        scaleFactorCurve);
                var newCenterX = (allCurves[selectedCurve].StartX +
                    allCurves[selectedCurve].EndX) / 2;
                var newCenterY = (allCurves[selectedCurve].StartY +
                    allCurves[selectedCurve].EndY) / 2;
                var offsetX = newCenterX - centerX;
                var offsetY = newCenterY - centerY;
            ...
            var t3 = allBezierCurves[selectedBezierCurve].StartX -
                allBezierCurves[selectedBezierCurve].EndX;
            t3 *= t3;
            var t4 = allBezierCurves[selectedBezierCurve].StartY -
                allBezierCurves[selectedBezierCurve].EndY;
            t4 *= t4;
            if ((t3 + t4 > 10000 && scaleFactorBezier === 0.9) ||
                scaleFactorBezier === 1.1) {
                var centerX = (allBezierCurves[selectedBezierCurve].StartX +
                    allBezierCurves[selectedBezierCurve].EndX) / 2;
                var centerY = (allBezierCurves[selectedBezierCurve].StartY +
                    allBezierCurves[selectedBezierCurve].EndY) / 2;
                allBezierCurves[selectedBezierCurve].StartX =
                    Math.round(allBezierCurves[selectedBezierCurve].StartX *
                        scaleFactorBezier);
                allBezierCurves[selectedBezierCurve].StartY =
                    Math.round(allBezierCurves[selectedBezierCurve].StartY *
                        scaleFactorBezier);
                allBezierCurves[selectedBezierCurve].ControlPoint1X =
                    Math.round(allBezierCurves[selectedBezierCurve].ControlPoint1X *
                        scaleFactorBezier);
                allBezierCurves[selectedBezierCurve].ControlPoint1Y =
                    Math.round(allBezierCurves[selectedBezierCurve].ControlPoint1Y *
                        scaleFactorBezier);
                allBezierCurves[selectedBezierCurve].ControlPoint2X =
                    Math.round(allBezierCurves[selectedBezierCurve].ControlPoint2X *
                        scaleFactorBezier);
                allBezierCurves[selectedBezierCurve].ControlPoint2Y =
                    Math.round(allBezierCurves[selectedBezierCurve].ControlPoint2Y *
                        scaleFactorBezier);
                allBezierCurves[selectedBezierCurve].EndX =
                    Math.round(allBezierCurves[selectedBezierCurve].EndX *
                        scaleFactorBezier);
                allBezierCurves[selectedBezierCurve].EndY =
                    Math.round(allBezierCurves[selectedBezierCurve].EndY *
                        scaleFactorBezier);
            ...
            allText[selectedText].FontSize += e.deltaY < 0 ? 1 :
                (allText[selectedText].FontSize - 1 > 6 ? -1 : 0);
            drawingCanvasCtx.font = allText[selectedText].FontSize +
                'px ' + allText[selectedText].FontName;
